...
namespace mes
{
    class SqlHelper
    {
        ...
        private static string conStr = GetConnSting();

        ///
        /// 获取一个sqldatareader
        ///
        public static SqlDataReader getMyDataReader(string sqlText, params SqlParameter[] parameters)
        {

            GetConnSting();
            //SqlDataReader要求，它读取数据的时候有，它独占它的SqlConnection对象，而且SqlConnection必须是Open状态
            SqlConnection conn = new SqlConnection(conStr);//不要释放连接，因为后面还需要连接打开状态
        ...
        public static DataTable getMyDataTable(string sqlText, params SqlParameter[] parameters) 
         {
        ...
        public static object getMyScalar(string sqlText, params SqlParameter[] parameters)
         {
        ...
        public static int getMyNonQuery(string sqlText, params SqlParameter[] parameters)
        {
            using (SqlConnection conn = new SqlConnection(conStr))
            {
                using (SqlCommand cmd = conn.CreateCommand())
        ...
        {
            return "server=10.1.10.9;uid=sa;pwd=pass123!;database=senyuan";
